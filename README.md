...
- 可选择冬日基础、大学四级、大学六级、考研英语、经典情景英语入门/进阶和混合挑战 7 个内置单词册；所有学习词包均为独立精选，不是官方考试或教材完整词表。
- 普通词与冰晶词分别使用无放回洗牌袋，并回避近期出现过的词；每册最长的 10 个词轮换为冰晶大雪花，完整一轮前不会重复。
- 冰晶大雪花造成 15 点群体伤害，并冻结对方所有存活角色 1 秒；普通雪球只攻击锁定时的敌方前排。
